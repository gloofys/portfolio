    ...
    <div class="flex items-center justify-between content-wrapper">
      ...
      <div class="flex items-center gap-4 mx-auto absolute left-1/2 transform -translate-x-1/2">
        <a href="https://www.linkedin.com/in/fred-brosman" target="_blank" rel="noopener noreferrer" class="inline-block">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="text-customBlue hover:text-blue-800 transition duration-300" viewBox="0 0 24 24">
      ...
      <div class="flex items-center">
        <button class="text-white focus:outline-none">
          <!-- Burger menu icon -->
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="white" class="text-customBlue" viewBox="0 0 24 24">
